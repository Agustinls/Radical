...
VALUES (null, 173066, 1, 1, 1, 1524.84, -4371.5, 18.1591, 4.7092, 0, 0, 0.708235, -0.705977, 25, 255, 1);

-- Cartel de la fuente de Dalaran

-- INSERT INTO `gameobject` (`guid`, `id`, `map`, `spawnMask`, `phaseMask`, `position_x`, `position_y`, `position_z`, `orientation`, `rotation0`, `rotation1`, `rotation2`, `rotation3`, -- `spawntimesecs`, `animprogress`, `state`)
-- VALUES (73369, 202443, 571, 1, 1, 5804.2, 639.833, 647.773, 5.59055, 0, 0, 0.339436, -0.940629, 300, 100, 1);
...
--VALUES (2000000217, 'Tell us! Where does you leader hide?', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Расскажите нам! Где ваш лидер скрывается?'),
...
--VALUES (487, 0, 0, 0, 0, 0, 0, 0, 2000000217, 0, 0, 0, 0, 0, 0, 0, '');

-- INSERT INTO `creature_movement_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
-- VALUES (490, 0, 0, 0, 0, 0, 0, 0, 2000000218, 0, 0, 0, 0, 0, 0, 0, '');
...
VALUES (72010, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2402.14, -5633.6, 377.02, 0.5, '');
