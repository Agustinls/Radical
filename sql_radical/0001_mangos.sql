...
VALUES (null, 28788, 609, 1, 32, 0, 0, 2352.66, -5702.3, 153.923, 2.45982, 25, 5, 0, 26140, 0, 0, 0);
...
VALUES (null, 3602.816895, 192.193237, -113.230606, 5.331965, 571, 'ElSagrarioRubi');
...
VALUES (1333, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2395.76, -5622.85, 377.01, 2.6, '');
	
DELETE FROM `gameobject_scripts` WHERE `id` = 1327;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (1327, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2395.76, -5622.85, 377.01, 2.6, '');
	
DELETE FROM `gameobject_scripts` WHERE `id` = 1332;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (1332, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2395.76, -5622.85, 377.01, 2.6, '');
	
DELETE FROM `gameobject_scripts` WHERE `id` = 43888;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (43888, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2395.76, -5622.85, 377.01, 2.6, '');
	
DELETE FROM `gameobject_scripts` WHERE `id` = 1342;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (1342, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2391.5, -5639.6, 420.8, 3.7, '');
	
DELETE FROM `gameobject_scripts` WHERE `id` = 1343;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (1343, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2391.5, -5639.6, 420.8, 3.7, '');

DELETE FROM `gameobject_scripts` WHERE `id` = 43889;	
INSERT INTO `gameobject_scripts` (`id`, `delay`, `command`, `datalong`, `datalong2`, `datalong3`, `datalong4`, `data_flags`, `dataint`, `dataint2`, `dataint3`, `dataint4`, `x`, `y`, `z`, `o`, `comments`)
VALUES (43889, 0, 6, 609, 0, 0, 0, 0, 0, 0, 0, 0, 2391.5, -5639.6, 420.8, 3.7, '');
